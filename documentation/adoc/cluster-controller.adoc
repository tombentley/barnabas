...
* `kafka-memory-request`: the memory request for Kafka containers, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.requests.memory`] setting.
                          Optional with no default.
* `kafka-cpu-request`: the cpu request for Kafka containers, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.requests.cpu`] setting.
                        Optional with no default.
* `kafka-memory-limit`: the memory request for Kafka containers, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.limits.memory`] setting.
                          Optional with no default.
* `kafka-cpu-limit`: the cpu request for Kafka containers, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.limits.cpu`] setting.
                        Optional with no default.
...
* `zookeeper-memory-request`: the memory request for Zookeeper containers, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.requests.memory`] setting.
                          Optional with no default.
* `zookeeper-cpu-request`: the cpu request for Zookeeper containers, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.requests.cpu`] setting.
                        Optional with no default.
* `zookeeper-memory-limit`: the memory request for Zookeeper containers, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.limits.memory`] setting.
                          Optional with no default.
* `zookeeper-cpu-limit`: the cpu request for Zookeeper containers, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.limits.cpu`] setting.
                        Optional with no default.
...
* `memoryRequest`: the memory request for topic controller container, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.requests.memory`] setting.
                          Optional with no default.
* `cpuRequest`: the cpu request for topic controller container, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.requests.cpu`] setting.
                        Optional with no default.
* `memoryLimit`: the memory request for topic controller container, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.limits.memory`] setting.
                          Optional with no default.
* `cpuLimit`: the cpu request for the topic controller container, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.limits.cpu`] setting.
                        Optional with no default.
...
* `memory-request`: the memory request for Kafka Connect containers, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.requests.memory`] setting.
                          Optional with no default.
* `cpu-request`: the cpu request for Kafka Connect containers, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.requests.cpu`] setting.
                        Optional with no default.
* `memory-limit`: the memory request for Kafka Connect containers, corresponding directly to Kubernetes'
                          {resources-link}[`spec.containers[\].resources.limits.memory`] setting.
                          Optional with no default.
* `cpu-limit`: the cpu request for Kafka Connect containers, corresponding directly to Kubernetes'
                       {resources-link}[`spec.containers[\].resources.limits.cpu`] setting.
                        Optional with no default.
