...
SUBDIRS=kafka-agent mirror-maker-agent crd-annotations test crd-generator api client mockkube certificate-manager operator-common cluster-operator topic-operator user-operator kafka-init test-client docker-images helm-charts install examples metrics
